...
CREATE TABLE `teams`(
team_id INT, -- 팀고유번호
name VARCHAR(100), -- 팀이름
city VARCHAR(100), -- 연고지
founded_year YEAR -- 창단연도 (YYYY-MM-DD)
);
#문제3
